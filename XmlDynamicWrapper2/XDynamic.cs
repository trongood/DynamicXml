...
namespace XmlDynamicWrapper2
{
    public class XDynamic : DynamicObject
    {
        ...
        protected internal void SetValueValueType(object value, string name)
        {
            ...
            if (targetXElement == null)
                throw new InvalidOperationException("XmlDynamicWrapper.XDynamic.TrySetMember: targetXElement is null");
